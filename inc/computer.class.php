...
<?php
      ...
      echo "</td></tr>\n";
       $randDropdown = mt_rand();
      echo "<td><label for='dropdown_mbbtag_id$randDropdown'>".__('MBB Tag')."</label></td>";
      echo "<td>";
     ?>
<!--
...
-->
<?php
        $objectName = autoName($this->fields["tag_id"], "tag_id",
                             (isset($options['withtemplate']) && ( $options['withtemplate']== 2)),
                             $this->getType(), $this->fields["entities_id"]);
      Html::autocompletionTextField(
         $this,
      ...
      echo "</td>";
          $randDropdown = mt_rand();
      echo "<td><label for='dropdown_Ownership_id$randDropdown'>".__('Ownership')."</label></td>";
      echo "<td>";
